package com.example.kr.myproject.advertscrollbar;
...
public class PublicNoticeView extends LinearLayout {
    ...
    public void bindLinearLayout() {
        ...
        viewFlipper.setInAnimation(AnimationUtils.loadAnimation(mContext, R.anim.anim_from_down_in));
        viewFlipper.setOutAnimation(AnimationUtils.loadAnimation(mContext, R.anim.anim_from_up_out));

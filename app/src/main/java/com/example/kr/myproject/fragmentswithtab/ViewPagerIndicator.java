package com.example.kr.myproject.fragmentswithtab;
...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 三角形的最大宽度
     */
    private final int DIMENSION_TRIANGEL_WIDTH = (int) (getScreenWidth(getContext()) / 3 * RADIO_TRIANGEL);
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            LayoutParams lp = (LayoutParams) view
                    .getLayoutParams();
            lp.weight = 0;
            lp.width = getScreenWidth(getContext()) / mTabVisibleCount;
    ...
    public void scroll(int position, float offset) {
        ...
        int tabWidth = getScreenWidth(getContext()) / mTabVisibleCount;
